        ...
        for (sourceVertex in vertices) {
            ...
            while (queue.isNotEmpty()) {
                ...
                for (successorVertex in successors(graph, currentVertex)) {
                    ...
                    if (distance.getValue(successorVertex) == distance.getValue(currentVertex) + 1) {
                        sourceVertexWeight[successorVertex] = sourceVertexWeight.getValue(successorVertex) + sourceVertexWeight.getValue(currentVertex)
            ...
            while (stack.isNotEmpty()) {
                ...
                if (successorVertex != sourceVertex) {
                    betweennessMap[successorVertex] = betweennessMap.getValue(successorVertex) + sourceVertexDependency.getValue(successorVertex)
                }
            }
        }
